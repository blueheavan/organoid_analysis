...
from analysis.segmentation import compare_instance_qc, segment
from analysis.evaluation import match_instances
...
def test_instance_qc_handles_sparse_large_ids_without_max_label_allocation():
    from analysis.segmentation import instance_qc_summary
