...
from analysis.io import write_labels
from analysis.multilevel3d import Multilevel3DConfig, analyze_multilevel_3d
from analysis.multilevel3d.export import export_results
from analysis.multilevel3d.qc import _volume_outliers
from analysis.multilevel3d.spatial import cell_spatial_features
...
def test_spatial_depth_map_is_cached_per_organoid():
    ...
    with patch("analysis.multilevel3d.spatial.ndi.distance_transform_edt", wraps=ndi.distance_transform_edt) as edt:
