...
from segmentation.io import load_zstack
from segmentation.io.metadata import Spacing
from ui.visualization import build_surface, render_mip_image, render_surface_image, render_volume_image
from ui.visualization._stpv import apply_stpv_patch
...
def main() -> None:
    ...
    if mode == "Surface":
        ...
        try:
            apply_stpv_patch()
            from ui.visualization._stpv import stpyvista_surface
            from ui.visualization import surface_to_dict
