...
from ui.vtk_viewer.core import build_viewer_payload, render_viewer_html
from ui.vtk_viewer.tests._optional_deps import HAS_PLAYWRIGHT
from ui.vtk_viewer.tests.test_viewer import _sphere_stack

ARTIFACTS = Path(__file__).parent / "artifacts"


def _sphere_stack(shape=(48, 64, 64)) -> np.ndarray:
    from ui.vtk_viewer.tests.test_viewer import _sphere_stack as _mk
    return _mk(shape)
...
class RenderSmokeTests(unittest.TestCase):
    ...
    def test_mask_overlay_renders_without_error(self) -> None:
        from ui.vtk_viewer.core import spec_to_dict
