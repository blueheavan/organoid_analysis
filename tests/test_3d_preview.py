...
from segmentation.io import Spacing, load_zstack
from segmentation.io.metadata import (
    classify_axes,
...
from segmentation.io.zstack_reader import _reorder_to_czyx
...
from ui.visualization.capabilities import probe_gpu_mapper


def _write_ome_zyx(path: str, vol: np.ndarray, **meta) -> None:
    tifffile.imwrite(
        path,
        vol,
        photometric="minisblack",
        metadata={"axes": meta.get("axes", "ZYX"), **meta},
        ome=True,
    )
