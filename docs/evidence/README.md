...
| `2026-09-13-volume-audit/` | Analysis of existing evidence; no new measurement | Audits the volume estimator from the two records above and proposes studies. Declares no domain and changes no algorithm | No (SG-2 stays FAIL / NOT QUALIFIED; SG-3 and SG-6 stay FAIL / INSUFFICIENT EVIDENCE) |
